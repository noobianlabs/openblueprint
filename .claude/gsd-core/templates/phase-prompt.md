...
<!-- For checkpoint task examples and patterns, see @/Users/noobian/dev/openblueprint/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/noobian/dev/openblueprint/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/noobian/dev/openblueprint/.claude/gsd-core/templates/user-setup.md` for full schema and examples
