...
```
Agent(
  prompt="Read /Users/noobian/dev/openblueprint/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/noobian/dev/openblueprint/.claude/gsd-core/templates/VALIDATION.md`
