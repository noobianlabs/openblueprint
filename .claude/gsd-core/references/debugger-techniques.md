...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/noobian/dev/openblueprint/.claude
                  → checks /Users/noobian/dev/openblueprint/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/noobian/dev/openblueprint/.claude/gsd-core
                  → writes to /Users/noobian/dev/openblueprint/.claude/gsd-core/hooks/
