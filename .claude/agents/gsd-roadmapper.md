...
Reference full template: `/Users/noobian/dev/openblueprint/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/noobian/dev/openblueprint/.claude/gsd-core/templates/state.md`.
