...
Use template from `/Users/noobian/dev/openblueprint/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/Users/noobian/dev/openblueprint/.claude/gsd-core/templates/UI-SPEC.md`
